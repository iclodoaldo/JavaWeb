                ...
                <div class="module-content">
                    <ul class="none">
                        <li>
                            ...
                            <p>Estamos disponibilizando a retirada de exames pelo nosso site, contribuindo assim para usa comodidade. 
                Acesse a área do cliente, ao lado, para visualizar os exemes feitos em nossos laboratórios e clique sobre o exame para acessar o resultado. </p>

                        </li>
                        <li>
                            <strong><a href="?" class="black">01 de Junho 2015</a></strong>
                            <p>A CRM na busca por atender melhor nossos clientes ampliou sua gama de exames oferecidos. Confira os novos exmaes!</p>
                            <ul class="bullet">
                                <li>Hexanodiona Urinário</li>
                                <li>Alfa Androstanediol Glicuronídeo</li>
                                <li>Nucleotidase</li>
                                <li>Radiografia panorâmica de toda a coluna vertebral</li>
                                <li>Eletroforese de lipoproteínas</li>
