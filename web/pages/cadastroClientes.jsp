...
<html>
    ...
    <select name="cpf">
        <option value=""></option>
        <c:forEach var="cpf" items="${qryCliente.rows}">
            <option value="${cpf.cpf}">${cpf.nome}</option>
        </c:forEach>
    </select>  Preencha este campo somente se necessitar ALTERAR um cliente já cadastrado!<br><br><br>
    ...
    <h4><a href="?action=excluirCliente">Para EXCLUIR um cliente CLIQUE AQUI</a></h4>
